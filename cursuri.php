        ...
        <div class="card-deck">
            ...
            <div class="card" style="width:400px">
                ...
                <div class="card-body">
                    ...
                    <?php
                    if(!$_SESSION['logat']) {
                        echo  '<div><a class=" btn btn-primary stretched-link" href="autentificare.php?mesaj_participare">Participa</a></div>';
                        ...
                        <form action="participare.php" method="post">
                            ...
                            <input type="submit" value="Participa" name="submit" class="btn btn-primary stretched-link" />
                        </form>
                        <?php
                    }
                    ?>
